...
None of the PM skills make network calls, install packages, or read credentials. The tracking hooks from `ai-harness-design` log tool usage **locally** to files in your own `.claude/` directory; nothing leaves your machine.
